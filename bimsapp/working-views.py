                            ...
                            for row in chunk:
                                ...
                                for j in output_strings:
                                    if any(first_name and middle_name and last_name and dob and part in j.strip() for part in dec_aadhar):
                                            ...
                                            # Smart contract integration
                                            verification_url = f"https://e0bfric3h9-e0gc9utcak-connect.de0-aws.kaleido.io/gateways/e0z7dzqo8f/?kld-from=0xc916d7e0731fd8951c81981217c6a863796857b4&kld-sync=true"
                                            ...
                                            # Make the API request to submit verification to the smart contract
                                            response = requests.post(verification_url, data=json_payload)
                                            ...
                                            if response.status_code == 200:
                                                # Verification successful
                                                transaction_id = response_content.get('transactionHash')
                                                print (f"Transaction ID: {transaction_id}")
                                                #watermark
                                                font_path = "/home/ubuntu/bims/fonts/Roboto-Regular.ttf"
                                                watermarked_image = add_watermark(uploaded_file, transaction_id, font_path)       
                            ...
                            for row in chunk:
                                ...
                                for j in output_strings:
                                    if (first_name and father_name and last_name and dob and heading1 and heading2 in j.strip()):
                                            ...
                                            # Smart contract integration
                                            contract_address = "0xc916d7e0731fd8951c81981217c6a863796857b4"  # Replace with the actual contract address
                                            verification_url = f"https://e0bfric3h9-e0gc9utcak-connect.de0-aws.kaleido.io/gateways/e0hwi955ix/?kld-from=0xc916d7e0731fd8951c81981217c6a863796857b4&kld-sync=true"
